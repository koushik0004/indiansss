				...
				<div class="clearfix" style="display:block;">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr align="center" <?php echo ($cnt%2!=0)?'class="odd"':''; ?>>
                        ...
                        <td width="19%"><a href="<?php echo site_url(ADMIN.'journals/manuscript_approval/'.$single['id'].'/'.$approved_status.'/'.$pagenumber.''); ?>" title="<?php echo 'Click to '.($approved_status=='1'?'disapprove':'approve').'the mmanuscript'; ?>"><img src="<?php echo base_url();?>assats/control/img/<?php echo ($approved_status=='1')?'status-inactive.png':'status-active.png'; ?>" border="0" /></a>&nbsp;&nbsp;<a href="<?php echo site_url(ADMIN.'journals/delete_manuscript/'.$single['id'].'/'.$pagenumber.''); ?>" title="delete manuscript"><img src="<?php echo base_url();?>assats/control/img/delete-user.png" border="0" /></a></td>
                      </tr>
