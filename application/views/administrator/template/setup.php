...
<title>Administrator - Ultimate Admin Panel Solution</title>
    ...
    <!-- end header -->
		...
		<div id="content_main" class="clearfix">
			...
			<div id="shortcuts" class="clearfix">
				...
				<ul>
					<li class="first_li"><a href=""><img src="<?php echo base_url();?>assats/control/img/theme.jpg" alt="themes" /><span>Themes</span></a></li>
					<li><a href=""><img src="<?php echo base_url();?>assats/control/img/statistic.jpg" alt="statistics" /><span>Statistics</span></a></li>
					<li><a href=""><img src="<?php echo base_url();?>assats/control/img/ftp.jpg" alt="FTP" /><span>FTP</span></a></li>
					<li><a href=""><img src="<?php echo base_url();?>assats/control/img/users.jpg" alt="Users" /><span>Users</span></a></li>
					<li><a href=""><img src="<?php echo base_url();?>assats/control/img/comments.jpg" alt="Comments" /><span>Comments</span></a></li>
					<li><a href=""><img src="<?php echo base_url();?>assats/control/img/gallery.jpg" alt="Gallery" /><span>Gallery</span></a></li>
					<li><a href=""><img src="<?php echo base_url();?>assats/control/img/security.jpg" alt="Security" /><span>Security</span></a></li>
		...
		<table id="table">
			...
			<tr>
				...
				<td><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accepted"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg" alt="cancel"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/folder.jpg" alt="folder"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/edit.jpg" alt="edit"/></a></td>
			...
			<tr>
				...
				<td><a href="#">Webdesign, Life, Custom</a></td>
				<td><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accepted"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg" alt="cancel"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/folder.jpg" alt="folder"/></a><a href="#"><img src="img/edit.jpg" alt="edit"/></a></td>
				<td><span class="approved">Approved</span></td>
			</tr>
			<tr>
				<td class="table_check"><input type="checkbox" class="noborder" /></td>
		...
		<div id="panels" class="clearfix">
			<div class="panel photo left">
				...
				<ul class="clearfix">
					<li><img src="<?php echo base_url();?>assats/control/photos/1.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accept"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="<?php echo base_url();?>assats/control/photos/2.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accept"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="<?php echo base_url();?>assats/control/photos/3.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accept"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="<?php echo base_url();?>assats/control/photos/2.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accept"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="<?php echo base_url();?>assats/control/photos/1.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accept"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="<?php echo base_url();?>assats/control/photos/2.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accept"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="<?php echo base_url();?>assats/control/photos/1.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>assats/control/img/accept.jpg" alt="accept"/></a><a href="#"><img src="<?php echo base_url();?>assats/control/img/cancel.jpg"  alt="deny"/></a></span></li>
