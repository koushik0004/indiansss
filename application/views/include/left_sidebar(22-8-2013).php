...
been an important income source for the locals-->
				<?php 
					...
					echo stripslashes($textval);?>... <br /><br />
			<?php endif; ?>
            <span class="read_more"><a href="<?php echo base_url(); ?>pdf/2013-issues/summer-issues/Article1_Lakpa.pdf" target="_blank">Read More</a></span><br />
